...
public class CacheWorker {
    ...
    public CacheWorker(Context _context, String cachePath, boolean timeSortASC) {
        ...
        searchThreadPool = DDAIThreadPool.newThreadPool(downloadPoolMaxCore, 20, 5, !timeSortASC);
        downloadThreadQueue = DDAIThreadPool.newThreadPool(downloadPoolMaxCore, 6, 2,
                !timeSortASC);
